        ...
        <li>
          <div className="book">
            <div className="book-top">
              <div className="book-cover" style={{ width: 128, height: 193, backgroundImage:`url(${book.backgroundImage?book.backgroundImage:"https://via.placeholder.com/128x193?text=No%20Cover%20Image"})` }}></div>
            ...
            <div className="book-title">{book.title}{book.backgroundImage}</div>
